...
public class MyActivityIntro extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.Tab tab = actionBar.newTab()
                ...
                .setTabListener(new TabsListener(
                        this, "Informacion", FragmentsInformacionIntro.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Video")
                .setTabListener(new TabsListener(
                        this, "video", FragmentsVideoInto.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Cuestionario")
                .setTabListener(new TabsListener(
                        this, "cuestionario", FragmentsCuestionarioIntro.class));
        actionBar.addTab(tab);
