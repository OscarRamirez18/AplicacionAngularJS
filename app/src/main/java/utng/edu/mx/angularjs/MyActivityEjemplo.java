...
public class MyActivityEjemplo extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.Tab tab = actionBar.newTab()
                ...
                .setTabListener(new TabsListener(
                        this, "Informacion", FragmentsInformacionEjemplo.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Video")
                .setTabListener(new TabsListener(
                        this, "video", FragmentsVideoEjemplo.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Cuestionario")
                .setTabListener(new TabsListener(
                        this, "cuestionario", FragmentsCuestionarioEjemplo.class));
        actionBar.addTab(tab);
