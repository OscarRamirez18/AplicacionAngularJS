...
public class MyActivityObject extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.Tab tab = actionBar.newTab()
                ...
                .setTabListener(new TabsListener(
                        this, "Informacion", FragmentsInformacionObject.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Video")
                .setTabListener(new TabsListener(
                        this, "video", FragmentsVideoObject.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Cuestionario")
                .setTabListener(new TabsListener(
                        this, "cuestionario", FragmentsCuestionarioObject.class));
        actionBar.addTab(tab);
