...
public class MyActivityRequisito extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.Tab tab = actionBar.newTab()
                ...
                .setTabListener(new TabsListener(
                        this, "Informacion", FragmentsInformacionRequisito.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Video")
                .setTabListener(new TabsListener(
                        this, "video", FragmentsVideoRequisito.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText("Cuestionario")
                .setTabListener(new TabsListener(
                        this, "cuestionario", FragmentsCuestionarioRequisito.class));
        actionBar.addTab(tab);
